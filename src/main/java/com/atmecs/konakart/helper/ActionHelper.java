...
/**
 * This ActionHelper class is used to help or provide the predefined program  or method for the Selenium automation.
...
public class ActionHelper extends Extent {
	 ...
	 * this locators send to the action method according to options.
	 */
	...
	/**
	 * action method take the below inputs  
	 * @param webdriver
	 * @param locator
	 ...
	 * @param value
	 * and perform the separate the locators and options.
	 * this locators send to the senKeys method according to options.
	 */
